...
export default function Champion() {
  ...
  async function onSubmit(e) {
    ...
    if (String(selectedAgentId).includes("placeholder")) {
      ...
      showStatus(
        `${card?.title || "This"} personality is coming soon! Please check back later.`,
        "error"
      );
      return;
    }
  ...
  return (
    <>
      <Head>
        <title>Champion Account Expansion - CultureHub</title>
      ...
      <div className="container">
        <header className="header">
          ...
          <h1 className="main-title">Champion Account Expansion</h1>
          <p className="subtitle">
            Practice influencing an Account Director to share strategic information that could unlock account expansion opportunities. Choose your conversation partner&apos;s personality type below.
          </p>
        </header>
              ...
              <div className="form-group consent-row">
                <label className="consent-label">
                  ...
                  <span>
                    ...
                    <a href="/privacy?from=champion">Privacy Notice</a>.
                  </span>
                </label>
      ...
      {/* ── BEAUTY-ONLY CSS (unchanged from feedback.js) ── */}
      <style jsx global>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .persona-title { font-size: 1.5rem; font-weight: 600; margin-bottom: 10px; }
