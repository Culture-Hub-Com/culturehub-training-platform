...
export default function Coaching() {
  ...
  async function onSubmit(e) {
    ...
    const payload = {
      ...
      scenario: "coaching_missed_minutes",
      attempt,
    };
    ...
    try {
      ...
      setIsInCall(true);
      setIsStarting(false);
      showStatus("Connected! You can start coaching.", "success");
    } catch (err) {
      console.error(err);
      setIsStarting(false);
  ...
  return (
    <>
      <Head>
        <title>Coaching Simulation – Missed Minutes | CultureHub</title>
          ...
          >
            ...
            <form id="trainingForm" onSubmit={onSubmit} style={{ display: isInCall ? "none" : "block" }}>
              ...
              <button
                ...
                disabled={!canSubmit}
              >
                {isStarting ? "Connecting…" : "Start Coaching Conversation"}
