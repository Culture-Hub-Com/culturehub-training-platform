    ...
    <>
      ...
      <div className="container">
        <header className="header">
          ...
          <h1 className="main-title">Customer Scenario Training</h1>
          <p className="subtitle">
            Practice a conversation with a customer is frustrated that their equipment has broken down. Choose your conversation
