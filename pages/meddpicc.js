...
export default function MEDDPICC() {
  ...
  async function onSubmit(e) {
    ...
    const payload = {
      ...
      scenario: "meddpicc", // Changed from "feedback"
      attempt,
    };
  ...
  return (
    <>
      <Head>
        <title>MEDDPICC Coaching Training - CultureHub</title>
      ...
      <div className="container">
        <header className="header">
          ...
          <p className="subtitle">
            ...
            You will play the role of a line manager and will coach your salesperson Jaime to improve the use of qualification tools. Choose your personality type below.
          </p>
        </header>
              ...
              <div className="form-group consent-row">
                <label className="consent-label">
                  ...
                  <span>
                    ...
                    <a href="/privacy?from=meddpicc">Privacy Notice</a>.
                  </span>
                </label>
